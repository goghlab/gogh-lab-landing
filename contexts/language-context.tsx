...
const translations = {
  en: {
    ...
    "work.project2.tag2": "Interface Design",
    "work.project2.tag3": "Interaction",
  ...
  zh: {
    ...
    // Work page
    "work.title": "我們的作品",
    "work.project1.title": "極簡品牌形象",
    "work.project1.client": "香港金融集團",
    "work.project1.tag1": "品牌設計",
    "work.project1.tag2": "標誌設計",
    "work.project1.tag3": "視覺識別",
    "work.project2.title": "簡潔用戶體驗設計",
    "work.project2.client": "科技初創公司",
    "work.project2.tag1": "用戶體驗",
    "work.project2.tag2": "界面設計",
    "work.project2.tag3": "互動設計",
    "work.project3.title": "黑白網頁體驗",
    "work.project3.client": "奢侈品零售品牌",
    "work.project3.tag1": "網頁設計",
    "work.project3.tag2": "動畫效果",
    "work.project3.tag3": "極簡主義",
